...
$this->title = 'Что делать после регистрации';
use yii;
...
<div class="main_box">
    ...
    <div class="page_box">
        ...
        <h4 style="margin-top: 20px">Что делать после регистрации</h4>
        <div style="padding:86.25% 0 0 0;position:relative;margin: 20px 0">
            <iframe src="https://player.vimeo.com/video/1027406874" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe>
